...
namespace Monarch.Controllers
{
    public class ButterfliesController : Controller
    {
        ...
        {
            var butterflies = db.Butterflies.Include(b => b.Person);
        ...
        public ActionResult Create([Bind(Include = "ButterflyId,PersonId,Name,Species,Latitude,Longitude,City,StateProvince,Country,PostalCode,DateTime")] Butterfly butterfly)
        {
            ...
            ViewBag.PersonId = new SelectList(db.People, "PersonId", "Name", butterfly.PersonId);
            return View(butterfly);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ButterflyId,PersonId,Name,Species,Latitude,Longitude,City,StateProvince,Country,PostalCode,DateTime")] Butterfly butterfly)
        {
            if (ModelState.IsValid)
            {
